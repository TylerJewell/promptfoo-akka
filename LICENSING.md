...
A `LICENSE-promptfoo` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo), Copyright
Promptfoo 2025, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../promptfoo-port/specs/SPEC-001-promptfoo.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
